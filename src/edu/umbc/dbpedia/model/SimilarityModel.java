...
public class SimilarityModel {
	...
	public SimilarityModel() throws Exception {
    	...
    	//String modelLocation = "/home/lushan1/nlp/model/stanford/pos-tagger/english-bidirectional/english-bidirectional-distsim.tagger";
    	String modelLocation = "/home/lushan1/nlp/model/stanford/pos-tagger/wsj-bidirectional/wsj-0-18-bidirectional-distsim.tagger";

		System.out.println("Reading model from file=" + modelLocation);
        tagger = new MaxentTagger(modelLocation);
        morph = new Morphology();
        
        conceptSimModel1 = null; // SimilarityArrayModel.readModel("/home/lushan1/nlp/model/BigArray/webbase2012AllW2_S2");
		//relationSimModel1 = SimilarityArrayModel.readModel("/home/lushan1/nlp/model/BigArray/ceilling_cut/webbase2012AllW5_S3");
        relationSimModel1 = SimilarityArrayModel.readModel("/home/lushan1/nlp/model/BigArray/ceilling_cut/webbase2012AllPlusW5_S3");
		//relationSimModel1 = SimilarityArrayModel.readModel("/home/lushan1/nlp/model/BigArray/ceilling_cut/webbase2012Allv2W5_S3");

		conceptSimModel2 = null; //SimilarityArrayModel.readModel("/home/lushan1/nlp/model/BigArray/Gigawords2009AllW2_S2");
		relationSimModel2 = null; //SimilarityArrayModel.readModel("/home/lushan1/nlp/model/BigArray/Gigawords2009AllW5_S3");
		
		//d_check = new DependencyCheck();
		
		System.out.println("Reading antonym set ... ");
		//File antonymFile = new File("/home/lushan1/testbed/STS/data/AntonymsLexicon_old");
		//File antonymFile = new File("/home/lushan1/testbed/STS/data/WNet-antonyms-clean-pos.txt");
		//File antonymFile = new File("/home/lushan1/testbed/STS/data/emptyLexicon");
		File antonymFile = new File("/home/lushan1/testbed/STS/data/AntonymsLexicon");
	...
	public static void main(String[] args) throws Exception {
    	...
    	//model.computePhraseSimilarityFromFileInput("/home/lushan1/testbed/STS/STS2012-train/STS.input.SMTeuroparl.txt", "/home/lushan1/testbed/STS/output/abhay/STS.output.train.SMTeuroparl.txt");
    	//model.computePhraseSimilarityFromFileInput("/home/lushan1/testbed/STS/STS2012-test/STS.input.SMTeuroparl.txt", "/home/lushan1/testbed/STS/output/abhay/STS.output.test.SMTeuroparl.txt");

    	//model.computePhraseSimilarityFromFileInput("/home/lushan1/testbed/STS/STS2012-train/STS.input.MSRpar.txt", "/home/lushan1/testbed/STS/output/abhay/STS.output.train.MSRpar.txt");
    	//model.computePhraseSimilarityFromFileInput("/home/lushan1/testbed/STS/STS2012-test/STS.input.MSRpar.txt", "/home/lushan1/testbed/STS/output/abhay/STS.output.test.MSRpar.txt");

    	//model.computePhraseSimilarityFromFileInput("/home/lushan1/testbed/STS/STS2012-train/STS.input.MSRvid.txt", "/home/lushan1/testbed/STS/output/abhay/STS.output.train.MSRvid.txt");
    	//model.computePhraseSimilarityFromFileInput("/home/lushan1/testbed/STS/STS2012-test/STS.input.MSRvid.txt", "/home/lushan1/testbed/STS/output/abhay/STS.output.test.MSRvid.txt");

    	//model.computePhraseSimilarityFromFileInput("/home/lushan1/testbed/STS/STS2012-test/STS.input.surprise.OnWN.txt", "/home/lushan1/testbed/STS/output/abhay/STS.output.test.surprise.OnWN.txt");
    	//model.computePhraseSimilarityFromFileInput("/home/lushan1/testbed/STS/STS2012-test/STS.input.surprise.SMTnews.txt", "/home/lushan1/testbed/STS/output/abhay/STS.output.test.surprise.SMTnews.txt");
		...
		/*
    	model.computePhraseSimilarityFromFileInput("/home/lushan1/testbed/STS/STS2012-train/STS.input.SMTeuroparl.txt", "/home/lushan1/testbed/STS/output/STS.output.train.SMTeuroparl" + batch + ".txt");
    	model.computePhraseSimilarityFromFileInput("/home/lushan1/testbed/STS/STS2012-test/STS.input.SMTeuroparl.txt", "/home/lushan1/testbed/STS/output/STS.output.test.SMTeuroparl" + batch + ".txt");
    	System.out.println("SMTeuroparl is done.");
    	*/
    	
    	model.computePhraseSimilarityFromFileInput("/home/lushan1/testbed/STS/STS2012-train/STS.input.MSRpar.txt", "/home/lushan1/testbed/STS/output/STS.output.train.MSRpar" + batch + ".txt");
    	model.computePhraseSimilarityFromFileInput("/home/lushan1/testbed/STS/STS2012-test/STS.input.MSRpar.txt", "/home/lushan1/testbed/STS/output/STS.output.test.MSRpar" + batch + ".txt");
    	System.out.println("MSRpar is done.");

    	model.computePhraseSimilarityFromFileInput("/home/lushan1/testbed/STS/STS2012-train/STS.input.MSRvid.txt", "/home/lushan1/testbed/STS/output/STS.output.train.MSRvid" + batch + ".txt");
    	model.computePhraseSimilarityFromFileInput("/home/lushan1/testbed/STS/STS2012-test/STS.input.MSRvid.txt", "/home/lushan1/testbed/STS/output/STS.output.test.MSRvid" + batch + ".txt");
    	System.out.println("MSRvid is done.");

    	model.computePhraseSimilarityFromFileInput("/home/lushan1/testbed/STS/STS2012-test/STS.input.surprise.OnWN.txt", "/home/lushan1/testbed/STS/output/STS.output.test.surprise.OnWN" + batch + ".txt");
    	//model.computePhraseSimilarityFromFileInput("/home/lushan1/testbed/STS/STS2012-test/STS.input.surprise.SMTnews.txt", "/home/lushan1/testbed/STS/output/STS.output.test.surprise.SMTnews" + batch + ".txt");
    	System.out.println("OnWN is done.");
    	
    	
    	model.computePhraseSimilarityFromFileInput("/home/lushan1/testbed/STS/test-core/STS.input.SMT.txt", "/home/lushan1/testbed/STS/test-core/output/STS.output.SMT" + batch + ".txt");
    	System.out.println("SMT is done.");

    	model.computePhraseSimilarityFromFileInput("/home/lushan1/testbed/STS/test-core/STS.input.OnWN.txt", "/home/lushan1/testbed/STS/test-core/output/STS.output.OnWN" + batch + ".txt");
    	System.out.println("OnWN is done.");

    	model.computePhraseSimilarityFromFileInput("/home/lushan1/testbed/STS/test-core/STS.input.headlines.txt", "/home/lushan1/testbed/STS/test-core/output/STS.output.headlines" + batch + ".txt");
    	System.out.println("headlines is done.");

    	model.computePhraseSimilarityFromFileInput("/home/lushan1/testbed/STS/test-core/STS.input.FNWN.txt", "/home/lushan1/testbed/STS/test-core/output/STS.output.FNWN" + batch + ".txt");
		...
		*/
		...
		//model.computePhraseSimilarityFromFileInput("/home/lushan1/testbed/STS/JHU/allPairs.txt", "/home/lushan1/testbed/STS/runtime/output/allPairs.out");
